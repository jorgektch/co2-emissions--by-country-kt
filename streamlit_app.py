...
# Validar si el país tiene datos válidos
if country_data['CO2 Emissions'].isnull().all():
    st.write(f"El país seleccionado ({country_selected}) no tiene datos de emisiones de CO2 válidos para realizar un análisis.")
else:
